...
VALUES ('beloved@uece.br', '001', 'Mathew Paixas', '14151617', 'malone.png', 2),
...
VALUES ('the_alan_turing@uece.br', '0101000101', true, 'Alan Turing', '23.06.1912', 'turing.png', 2),
...
VALUES ('alicinha@uece.br', '2424', 'Alicia Paiva', 'bob esponja', 'alicia.png', 2),
...
VALUES ('Breaking Criptograpy', 'How to break encoded messages in a WW', 'How to break encoded messages in a WW, by someone that did it', '2025-01-01', '2025-02-20', 'tm_workshop.png', 10, 1, 200, '', true, false, 1, 1),
...
VALUES ('2025-02-21', '8:30', '11:00', 1),
...
/*
 public | api_activitytype           | table | postgres
 public | api_attendance             | table | postgres
 public | api_certificate            | table | postgres
 public | api_complementaryactivity  | table | postgres
 public | api_event                  | table | postgres
 public | api_eventdate              | table | postgres
 public | api_eventenrollment        | table | postgres
 public | api_major                  | table | postgres
 public | api_principal              | table | postgres
 public | api_professor              | table | postgres
 public | api_student                | table | postgres
